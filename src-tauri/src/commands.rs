    ...
    let results = profiles
        ...
        .filter_map(|profile| {
            ...
            Some(AppScanResult {
                ...
                migration_warning_i18n: profile.migration_warning_i18n.clone(),
                migration_warning_countdown_seconds: (profile.migration_warning_countdown_seconds
                    > 0)
                .then_some(profile.migration_warning_countdown_seconds),
                icon_path,
                icon_data_url,
...
pub fn migrate_app(
    ...
    if selected_unit.risk_level.eq_ignore_ascii_case("high") && !req.confirm_high_risk {
        return Err(CommandError::new(
...
mod tests {
    ...
    fn profile_relocation_units_filters_empty_source_units() {
        let profile = AppProfile {
            ...
            migration_warning_i18n: Default::default(),
            migration_warning_countdown_seconds: 0,
